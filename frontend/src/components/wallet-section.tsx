      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        ...
        <CollapsibleContent>
          <p className="text-sm text-gray-700 mb-4">
            This wallet was generated by the backend to start funding the BitVMX
            protocol. En el caso de Regtest, 50 BTC fueron fondeados de forma
            automática por el backend para propósitos de prueba.
          </p>
