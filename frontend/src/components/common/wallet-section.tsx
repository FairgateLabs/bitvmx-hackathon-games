...
import { usePubKey } from "@/hooks/useAddress";
...
export function WalletSection() {
  ...
  const { data: addressData, isLoading, error } = usePubKey();
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        ...
        <CollapsibleContent>
          <p className="text-sm text-gray-700 mb-4">
            This public key was generated by the backend to provide initial
            funding. You receive 50 BTC to begin using the BitVMX protocol.
          </p>

          <p className="text-sm text-gray-700 mb-4">
            Please share this public key with the other player to establish a
            connection.
          </p>
          ...
          <div className="flex flex-row gap-8 text-sm">
            <div>
              ...
              <div className="flex items-center gap-2">
                <p className="font-mono text-xs break-all bg-gray-100 p-2 rounded">
                  {addressData?.pub_key ?? "Loading..."}
                </p>
                <CopyButton
                  text={addressData?.pub_key ?? ""}
                  size="sm"
                  variant="outline"
                />
              </div>
            ...
            <div>
              ...
              {network === NetworkType.Testnet ? (
                ...
                <p className="font-semibold pt-1">{50} BTC</p>
              )}
            </div>
          </div>
